...
// Clean, light-gray background for projects without photos
...
export const PROJECTS: Project[] = [
...

  {
    ...
    heroImage: CLEAN_BG, // Replaced placeholder
    gallery: [],
...

  {
    ...
    entities: { authorities: ["gttc"], partners: ["NSL"] },
    category: { primary: "Institutional", secondary: [] },
    tags: ["govt", "tool-room"],
...

  {
    ...
    entities: { authorities: ["hospet-mc"], partners: ["IVRCL"] },
...

  {
    ...
    entities: { authorities: ["chitradurga-mc"], partners: ["IVRCL"] },
    category: { primary: "Infrastructure", secondary: [] },
    tags: ["slum", "urban"],
...

  {
    ...
    entities: { authorities: ["indian-railways"] },
    category: { primary: "Infrastructure", secondary: [] },
...

  {
    ...
    entities: { authorities: ["hindupur-municipality"] },
    category: { primary: "Water & STP", secondary: [] },
...

  {
    ...
    entities: { authorities: ["irrigation-ka"], partners: ["IVRCL", "GVPR"] },
    category: { primary: "Infrastructure", secondary: [] },
...

  {
    ...
    entities: { authorities: ["water-board-ap"], partners: ["LNT"] },
    category: { primary: "Water & STP", secondary: [] },
    tags: ["water", "pipeline"],
